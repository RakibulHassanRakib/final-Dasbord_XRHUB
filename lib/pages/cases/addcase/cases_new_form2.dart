...
class CasesAddForm2 extends StatefulWidget {
  final AppState appState;
  CasesAddForm2({Key key, this.appState}) : super(key: key);

  @override
  _CasesFormState2 createState() => _CasesFormState2();
}

class _CasesFormState2 extends State<CasesAddForm2> {
  ...
  var selectedClient;
  var respondantname = "";
  //final stageofcase2 = TextEditingController();
  var respondantadv = "";
  var casenumber = "";
  var casename = "";
  var casedesp = "";
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      showDatePicker(
                                          ...
                                          .then((value) {
                                        setState(() {
                                          filingdate = DateFormat('EEE, d/M/y')
                                              .format(value)
                                              .toString();
                                        });
                                      });
