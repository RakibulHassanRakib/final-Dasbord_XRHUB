...
class ChatStateless extends StatelessWidget {
  final String chatRoomId;

  const ChatStateless(this.chatRoomId);
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          addMessage(messageEditingController);
  ...
  Widget chatMessages(Stream<QuerySnapshot> chats) {
  ...
  addMessage(TextEditingController messageEditingController) {
    if (messageEditingController.text.isNotEmpty) {
      ...
      addMessage2(chatRoomId, chatMessageMap);
    }
  }
