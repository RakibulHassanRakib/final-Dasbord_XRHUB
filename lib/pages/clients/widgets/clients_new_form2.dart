...
class ClientsForm extends StatefulWidget {
  ...
  const ClientsForm({Key key, this.appState}) : super(key: key);

  @override
  _ClientFormState createState() => _ClientFormState();
}

class _ClientFormState extends State<ClientsForm> {
...
enum ClientGender { male, female, unspecified }

class ClientRefs {
  //complex drawer menu
  final String refname;
  final String refmobilenum;
  final String refemail;
  final String refadd;

  ClientRefs(this.refname, this.refmobilenum, this.refemail, this.refadd);
}
